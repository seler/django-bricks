...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brick.description'
        db.alter_column('bricks_brick', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Brick.description'
        db.alter_column('bricks_brick', 'description', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
