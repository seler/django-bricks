...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollectionObject.is_active'
        db.add_column(u'collections_collectionobject', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollectionObject.is_active'
        db.delete_column(u'collections_collectionobject', 'is_active')
