...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'images.resizedimage': {
            ...
            'resized_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
