...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'images_image', 'width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.height'
        db.add_column(u'images_image', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.size'
        db.add_column(u'images_image', 'size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        db.alter_column(u'images_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256))

    def backwards(self, orm):
        # Deleting field 'Image.width'
        db.delete_column(u'images_image', 'width')

        # Deleting field 'Image.height'
        db.delete_column(u'images_image', 'height')

        # Deleting field 'Image.size'
        db.delete_column(u'images_image', 'size')
        ...
        # Changing field 'Image.image'
        db.alter_column(u'images_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
