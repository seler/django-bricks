...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleSection.text'
        db.add_column('articles_articlesection', 'text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleSection.text'
        db.delete_column('articles_articlesection', 'text')
