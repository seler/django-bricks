...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'articles_articlesection', 'article_section_type', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'ArticleSection.article_section_type'
        db.alter_column(u'articles_articlesection', 'article_section_type', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'articles.articlesection': {
            ...
            'article_section_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '32'}),
